...
{
  internal class DebugSender : IScoreBoard
  {
    ...
    public DebugSender(int SerialPort, int RefreshInterval)
    {
      _refresh_interval = RefreshInterval;
      _serial_port = Convert.ToInt16(SerialPort);
      _ser_out = new System.IO.Ports.SerialPort("COM" + _serial_port.ToString(), 115200, Parity.None, 8, StopBits.One);
